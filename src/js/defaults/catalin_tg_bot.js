...
export const
    ...
    apiUrl = 'https://groups.adminbase.ru/api/',
    getAppUrl = apiUrl + 'apps.get',
    payloadUrl = apiUrl + 'payload.send',
    subscribeNotifyUrl = 'https://groups.adminbase.ru/api/users.enableNotifications',
    getRegDateUrl = 'https://groups.adminbase.ru/api/users.getRegDate',
