...
export default class extends React.Component {
    ...
    async getStoryCanvas() {
        ...
        * */
        ...
        ctx.drawImage(imgDiagram, 0, 0, 200, 200);
        /*========================*/
    ...
    render() {
        const {need_panel_upload_photo, analyze, snackbar, regDate, maxViews, friends_data} = this.state;
        ...
        return (
            ...
            >
                ...
                <Panel id='analyze'>
                    ...
                    >
                        <p>
                            Помимо количества твоих посетителей я могу рассказать о том, какие девушки тобой
                            интересуются.
                    ...
                    <img alt='bg' className='bg' src={require('../assets/vk_analizator/background/analyze.webp')}/>
                </Panel>
