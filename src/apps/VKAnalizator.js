...
export default class extends React.Component {
    ...
    async getStoryCanvas() {
        ...
        ctx.font = '60px PP Neue Machina Ultrabold';
        ctx.fillText(shortIntegers(maxViews), 358.8 - 88, 998 + 60 - 19 + 40);

        ctx.fillStyle = '#86CDFF';
        ctx.fillText(decOfNum(maxViews, ['раз', 'раза', 'раз'], false).toUpperCase(), 358.8 - 88 + 10 + ctx.measureText(shortIntegers(maxViews)).width, 998 + 60 - 19 + 40);
        ...
        ctx.fillStyle = '#86CDFF';
        ctx.fillText(decOfNum(maxViews, ['раз', 'раза', 'раз'], false).toUpperCase(), 358.8, 998 + 60 + 75 + 8);
        ...
        try {
            ...
            if (getRegDate.response) {
                ...
                if (wall && wall.response) {
                    let savedMaxViews = getStorageValue('savedMaxViews3');
                    let maxViews = 0;
                    try {
                    ...
                    if (savedMaxViews === '') {
                        await setStorageValue('savedMaxViews3', maxViews + '');
                    } else {
    ...
    async goTop() {
        ...
        try {
            ...
            await this.setPopout(null);
            this.setSnackbar('Ошибка получения топа. Попробуйте позже.');
        ...
        return (
            ...
            >
                ...
                <Panel id='main'>
                    ...
                    >
                        <p>
                            Мы расскажем тебе сколько приблизительно раз твою страницу посмотрели за всю ее историю
                            *Рассчет идет по просмотрам на постах
                        </p>
                        <div
                            style={{
                ...
                <Panel id='result'>
                    ...
                    >
                        ...
                        <p>Твою страницу посмотрели приблизительно:</p>
                    </div>
                    <div
                        className='text'
                        style={{
                            background: `url(${require('../assets/vk_analizator/result/text_one_line.svg')}) no-repeat 100%`
                        }}
                    >
                        {
                            maxViews && <React.Fragment>
                                <p>{shortIntegers(maxViews)} <span>{decOfNum(maxViews, ['раз', 'раза', 'раз'], false)}</span></p>
                            </React.Fragment>
                        }
                    </div>
                    <div
                    ...
                    <div className='bottom-container'>
                        ...
                        >
                            <img alt='ic' src={require('../assets/vk_analizator/result/share-story.webp')}/>
                        ...
                        <div>
                            {
                                ...
                                <React.Fragment>
                                    ...
                                    <p>{shortIntegers(maxViews)} {decOfNum(maxViews, ['просмотр', 'просмотра', 'просмотров'], false)}</p>
                                </React.Fragment>
                            }
                        </div>
                        <div style={{
                            ...
                            top && top[activeTopTab].users.map((value, index) =>
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        <p>{shortIntegers(value[1])} {decOfNum(value[1], ['просмотр', 'просмотра', 'просмотров'], false)}</p>
                                    </div>
                                    <p>{index + 1}</p>
                                </div>
                            )
